...
BOOTMODE g_boot_mode_ex __nosavedata = UNKNOWN_BOOT;//lupingzhong_add 20140306
...
//lupingzhong_add 20140306 start
BOOTMODE get_boot_mode_ex(void)
{
    return g_boot_mode_ex;
}
//lupingzhong_add 20140306 end
...
EXPORT_SYMBOL(get_boot_mode_ex);//wangliangfeng 20140317 add for factory APK
