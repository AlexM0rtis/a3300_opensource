...
extern struct acc_hw* get_cust_kxtj2_1009_acc_hw(void);
...
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	obj->hw = get_cust_kxtj2_1009_acc_hw();
...
{
	struct acc_hw *hw = get_cust_kxtj2_1009_acc_hw();
	GSE_FUN();
...
static int __init kxtj2_1009_init(void)
{
    ...
    if(gsensor_driver_register(&kxtj2_1009_gsensor_driver))
