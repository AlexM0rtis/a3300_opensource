...
/*wangliangfeng 20140325 add patch ALPS01469415 for resolving white line when boot up start*/
...
/*wangliangfeng 20140325 add patch ALPS01469415 end*/
DAL_STATUS DAL_SetScreenColor(DAL_COLOR color)
{
	...
	size= DAL_GetLayerSize()-offset - DAL_address_burst_align();//for ALPS01469415
...
DAL_STATUS DAL_Init(UINT32 layerVA, UINT32 layerPA)
{
    ...
    int align = DAL_address_burst_align(); //for ALPS01469415
