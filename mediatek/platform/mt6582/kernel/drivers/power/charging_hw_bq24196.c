...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    //pull CE low
#if 1 
    mt_set_gpio_mode(GPIO_EN_BQ24196_PIN,GPIO_MODE_GPIO);  
    mt_set_gpio_dir(GPIO_EN_BQ24196_PIN,GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO_EN_BQ24196_PIN,GPIO_OUT_ZERO);    
#endif
    ...
    bq24196_set_vindpm(0x7); //VIN DPM check 4.68V //0xa 4.44
    bq24196_set_reg_rst(0x0);
	bq24196_set_wdt_rst(0x1); //Kick watchdog	
    bq24196_set_sys_min(0x5); //Minimum system voltage 3.5V	
	bq24196_set_iprechg(0x0); // 01 128ma 0x03//Precharge current 512mA
 ...
 static kal_uint32 charging_enable(void *data)
 {
	...
	{
		// add by zzf for power off charger
		bq24196_set_wdt_rst(0x1); //Kick watchdog
		...
		else
		{
	        ...
	        // add by zzf for power off charger
			 int a=0;
			 bq24196_set_wdt_rst(0x1);//kick watchdog
			// charging_set_cv_voltage(&a);
			 //charging_set_input_current(&a);
			 bq24196_set_chg_config(0x0);
