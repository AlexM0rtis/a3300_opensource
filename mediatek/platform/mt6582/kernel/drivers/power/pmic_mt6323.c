...
/*HQ_wangliangfeng 20130906 added for defining enable and disable vibration start */
#ifdef HQ_BOOT_WITH_VIBRATOR
	void Enable_Vibrator(void){
	 printk("[kernel:pmic_mt6323] >>> Enable_Vibrator()\r\n");
     kernel_vibrate_flag = true;//set vibration flag
     //setting vibration amplitude
     pmic_config_interface( (kal_uint32)(DIGLDO_CON40),
                             0x07,
                             (kal_uint32)(PMIC_RG_VIBR_VOSEL_MASK),
                             (kal_uint32)(PMIC_RG_VIBR_VOSEL_SHIFT)
	                         );

     pmic_config_interface( (kal_uint32)(DIGLDO_CON39),
                             0x01,
...
void Disable_Vibrator(void){
	printk("[kernel:pmic_mt6323] >>> Disable_Vibrator()\r\n");
     pmic_config_interface( (kal_uint32)(DIGLDO_CON39),
                             0x00,
                             (kal_uint32)(PMIC_RG_VIBR_EN_MASK),
                             (kal_uint32)(PMIC_RG_VIBR_EN_SHIFT)
...
/*HQ_wangliangfeng 20130906 added end */
#endif 
...
void pwrkey_int_handler(void)
{
		...
		if(upmu_get_pwrkey_deb()==1)    	    	
    {
		...
		{		
				//HQ_wangliangfeng 20130906 added for marking when powerkey is released.
				#ifdef HQ_BOOT_WITH_VIBRATOR
    ...
    else
    {
		...
		{
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[pwrkey_int_handler] Press pwrkey IPOD charging\n");

			//HQ_wangliangfeng 20130906 added for marking when powerkey is pressed.
			#ifdef HQ_BOOT_WITH_VIBRATOR
